            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(btn_analizar, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
...
/**
 * Método invocado cuando se realiza una acción en el botón "Analizar".
 * 
 * Este método maneja la lógica de la acción del botón "Analizar". 
 * Utiliza un objeto de la clase `analizador` para analizar el texto del editor
 * y generar una lista de tokens. Luego, muestra los tokens generados en la consola de texto.
 * 
 * @param evt El evento de acción que desencadenó la invocación del método.
 */

    private void btn_analizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_analizarActionPerformed
        // Crear una instancia de la clase analizador y llamar al método analizar con el texto del editor
        new analizador(lista_token).analizar(txt_editor.getText());
         // Iterar sobre la lista de tokens generados y mostrarlos en la consola de texto
